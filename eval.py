...
word_map_file = '/kaggle/input/wordmapcoco/pytorch/default/1/WORDMAP_coco_5_cap_per_img_5_min_word_freq.json'  # word map, ensure it's the same the data was encoded with and the model was trained with
