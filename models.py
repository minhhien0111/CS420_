...
#         vgg = torchvision.models.vgg16(pretrained=True)  # Pretrained ImageNet VGG-16
        
#         # Remove the fully connected layers (classifier)
#         modules = vgg.features  # Use only the convolutional layers
#         self.vgg = modules
...
#     def fine_tune(self, fine_tune=True):
#         """
#         Allow or prevent the computation of gradients for convolutional blocks 3 through 5 of the encoder.

#         :param fine_tune: Allow?
#         """
#         for p in self.vgg.parameters():
#             p.requires_grad = False
#         # Fine-tune only convolutional blocks 3 through 5
#         for c in list(self.vgg.children())[10:]:
#             for p in c.parameters():
#                 p.requires_grad = fine_tune
